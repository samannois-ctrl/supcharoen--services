...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 16, 2022 at 10:16 AM
...
DROP TABLE IF EXISTS `tbl_work_post_address`;
...
DROP TABLE IF EXISTS `work_car_application`;
CREATE TABLE `work_car_application` (
  ...
  `app_telephone` enum('1','2') NOT NULL COMMENT '1 new 2 renew',
  ...
  `end_protect_date` int(11) NOT NULL,
