							...
							<div class="card-body ">
									<div class="row">
															<div class="col-sm-2">
																...
																<div class="col-sm-2">
																	<label class="control-label">สด/ผ่อน</label>
																...
																<div class="col-sm-1">															
																	<button type="button" class="btn btn-info" style="margin-top: 25px; padding: 5px 30px;" onClick="listData()"><i class="fa fa-search"></i> ตกลง</button>
																</div>
									</div>
									<div class="row">
