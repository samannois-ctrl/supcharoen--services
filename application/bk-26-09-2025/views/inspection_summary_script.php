<script>
	function loadSummary(){
		...
		var select_year_name = $('#select_year  option:selected').text() ;
		 $.post('<?php echo base_url('Inspection/loadSummary')?>',{ select_day:select_day,select_month:select_month,select_month_name:select_month_name,select_year:select_year,select_day_end:select_day_end,select_month_end:select_month_end,select_year_name:select_year_name},function(data){
		  //console.log(data)
