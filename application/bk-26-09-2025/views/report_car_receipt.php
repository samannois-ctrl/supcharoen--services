                        ...
                        <div class="card card-topline-red">
                            <div class="card-head">
                                ...
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    <li>
                                        <a href="<?php echo base_url('Report_car/report_car_receipt_print'); ?>" target="_blank">
                                ...
                                <table class="table table-striped table-bordered table-hover table-checkable order-column full-width" id="example4">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="txt-center">ทะเบียน</th>
                                            <th class="txt-center">ประเภทงาน</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td align="center">ประกันภัย + พ.ร.บ. + ตรอ.</td>
