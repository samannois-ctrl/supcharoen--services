<?php include('phpconfig.php');  // $_GET['SizeA4'] = 2-> half a4  1->fullA4
	$query="SELECT address_name, tel1, address_org, cust_name , cust_sname , address_no , address_moo , address_alley , address_road , address_subdistric, address_disctric , address_province , address_postcode FROM tbl_work_data WHERE id = '".$_GET['DataID']."' ";
		...
		<tr>
			...
			<table width="100%" align="right">
				...
				<?php 
				  ...
				  }else if(($data['cust_name']!='')&&($data['address_name']=='')){ echo 'คุณ'.$data['cust_name']." ".$data['cust_sname']."<br>"; } ?>
					
				<?php if($data['address_org']!=''){ echo ''.$data['address_org']."&nbsp;<br>"; } ?>
				<?php if($data['tel1']!=''){ echo 'โทรศัพท์ '.$data['tel1']."&nbsp;<br>"; } ?>
				...
				<?php if($data['address_disctric']!=''){ echo 'อำเภอ '.$data['address_disctric']."&nbsp;&nbsp;"; } ?>
...
<?php }else if($_GET['SizeA4']==2){ ?>
  <table bgcolor="#9B494A" border="0" style="width:595px;height: 420px; ">
		<tr>
			<td colspan="2" valign="top">
				 <h4 style="text-align: left; padding-left: 30px; padding-top: 20px; ">
				ที่อยู่ผู้ส่ง</h4>
				<?php if($_SESSION['branch_id']=='2'){ ?>
				<h4 style="text-align: left; padding-left: 30px;">สถานตรวจสภาพรถทรัพย์ดีหลวง 2<br>
				คุณชวัลนุช ปาตังคะโร<br>
				098-270-0086<br>
				86/9 ม.9 ต.ชิงโค อ.สิงหนคร <br>
				จ.สงขลา 90280 </h4>
				  <?php } else  if($_SESSION['branch_id']=='3'){ ?>
				 <h4 style="text-align: left; padding-left: 30px;">	สถานตรวจสภาพรถ ทรัพย์ดีหลวง3<br>
					นายศตวรรษ ปาตังคะโร<br>
					โทร. 087-287-1144<br>
					239/115 ม.1 ต.สทิงหม้อ<br>
					อ.สิงหนคร จ.สงขลา 90280
		...
		<tr>
		<td width="1"></td>
			<td style="padding-left: 100px; padding-top: 20px;"  align="left" valign="top">
