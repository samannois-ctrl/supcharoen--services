													...
													<div class="card card-box">
														<div class="card-head">
															...
															<ol class="breadcrumb page-breadcrumb pull-right">
																<li><a href="<?php echo base_url('Insurance_PA/work_pa_payment_print');?>" target="_blank"><button type="button" class="btn btn-warning btn-sm"><i class="fa fa-print"></i> พิมพ์สำหรับลูกค้า</button></a></li>
															</ol>
														</div>
