...
<div class="col-md-6 col-sm-6">
		...
		<div class="card-head">
			...
			<div class="pull-right"><!--<button id="addRow1" class="btn btn-info btn-sm" onClick="window.location.href='<?php //echo base_url('Insurance_car/work_car_all')?>'"> <i class="fa fa-plus"></i> เพิ่มลูกค้ารายใหม่ </button>-->
				...
				<a href="<?php echo base_url('Insurance_car/work_insurance_add')?>"  class="btn btn-info btn-sm" >
...
<div id="showListCustomer"></div>
			  <div class="form-group row">
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<input name="cust_telephone_1" type="text" class="form-control custInput" id="cust_telephone_1" placeholder="Line"  value="<?php echo $cust_telephone_1?>"  <?php //echo $readonlyCustNane?>>
					</div>
					...
					<div class="col-sm-4">
						...
						<?php */?>
						<input type="hidden" name="cust_telephone_2" id="cust_telephone_2" value="">
						<input name="line_id" type="text" class="form-control custInput" id="line_id" placeholder="" value="<?php echo $line_id?>"  <?php //echo $readonlyCustNane?>>
					</div>
				...
				<div class="form-group row">
					...
					<div id="showPaymentText" class="col-sm-10 text-danger " style="font-weight: 500"></div>																	
				</div>
...
<div class="col-md-6 col-sm-6">
		...
		<div class="card-body " id="bar-parent1">
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<input name="vehicle_regis" type="text" class="form-control carInput" id="vehicle_regis" placeholder="ทะเบียนรถ"  value="<?php echo $vehicle_regis?>" onChange="setLicensePlate(this)"><!--onKeyUp="listSearchCar(this.value)"-->
					</div>
			  ...
			  <div class="form-group row">
					...
					<div class="col-sm-2">
						<input name="date_regist" type="text" class="form-control carInput" id="date_regist" placeholder=""  value="<?php echo $date_regist?>"  onChange="updateTaxExpire()" >

				  </div>
				  <div class="col-sm-3">
					<select id="month_regist" name="month_regist" class="form-select" aria-label=""  onChange="updateTaxExpire()" >
					...
					<div class="col-sm-3">
						<input name="year_car" type="text" class="form-control carInput" id="year_car" placeholder="ปี พ.ศ."  value="<?php echo $year_car?>" onChange="updateTaxExpire()" >
					</div>
				</div>
			...
			<option value="<?php echo $carType->id?>" <?php if($car_type_id==$carType->id){ echo "selected"; }?> ><?php echo $carType->type_full_name?></option>
				<?php }?>			
						</select><!--onChange="setdecardedug();getCarPremium();" -->
					</div>																	
				</div>
			<!--<div class="form-group row">
					<label class="col-sm-2 control-label" style="<?php //echo $hilightRed?>">ประเภทประกันภัย</label>
					<div class="col-sm-10">
						<input type="radio" id="insurance_personal" name="insurance_personal" value="1"> เบี้ยประกันภัยส่วนบุคคล <br>
						<input type="radio" id="insurance_personal" name="insurance_personal"  value="2"> เบี้ยประกันภัยรับจ้างให้เช่า <br>
			...
			<div class="form-group row">
					...
					<div class="col-sm-10" id="listCC">
						...
						<input type="hidden" id="type_premium_id_temp" name="type_premium_id_temp" value="<?php echo $type_premium_id?>">
					</div>																
				</div>
				<?php ?>
				<!--<div class="form-group" style="padding-top: 50px;">
