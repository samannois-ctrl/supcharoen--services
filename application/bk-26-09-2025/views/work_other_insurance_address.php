<?php  $postData = $this->insurance_model->getPostData($workID);
...
-->
                    ...
                    <div class="form-group" style="padding-top: 50px;">
                        ...
                        <div class="col-md-12 txt-center">
							...
							<input type="hidden" name="postWorkID" id="postWorkID" value="<?php echo $workID?>">
							<input type="hidden" name="postCustID" id="postCustID" >
                            <button type="button" class="btn btn-info btn-sm m-b-10" onClick="SavePostAddr('save')">บันทึกข้อมูล</button> &nbsp; &nbsp;  
