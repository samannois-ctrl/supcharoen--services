...
<div id="showListCustomer"></div>
			  <div class="form-group row">
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<input name="cust_telephone_2" type="text" class="form-control custInput" id="cust_telephone_2" placeholder="โทรศัพท์" value="<?php echo $cust_telephone_2?>"  <?php echo $readonlyCustNane?>>
					</div>
				</div>																
				<div class="form-group row">
					<label class="col-sm-2 control-label">สถานะ</label>
					<div class="col-sm-10" style="margin-top: 8px;">
						<input name="is_corporation" type="checkbox" id="is_corporation" value="1" <?php echo $chkCorp?> >
