                            ...
                            <div class="card card-topline-red">
                                <div class="card-head">
									...
									<ol class="breadcrumb page-breadcrumb pull-right" style="background: none;">
										<li><a href="<?php echo base_url('Report_car/report_car_accrual_customer_print');?>" target="_blank"><button type="button" class="btn btn-warning btn-sm"><i class="fa fa-print"></i> พิมพ์รายงานลูกค้าค้างจ่าย</button></a></li>
									</ol>
                                </div>
														...
														<div class="form-group row">
															...
															<div class="col-sm-2" style="margin-top: 8px;">
																<select class="form-select" aria-label="">
																	...
																	<option value="1">ประกัน</option>
																	<option value="2">พ.ร.บ.</option>
																	<option value="1">ประกัน และ พ.ร.บ.</option>
																	<option value="2">ภาษี</option>
																	<option value="1">ตรวจสภาพรถ</option>
																	<option value="2">งานบริการ</option>
																	<option value="1">งานขนส่ง</option>
