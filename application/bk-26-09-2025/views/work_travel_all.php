				...
				<div class="page-bar">
					...
					<div class="page-title-breadcrumb">
						...
						<div class="pull-left">
							...
							<div class="page-title">ข้อมูลประกันภัยท่องเที่ยว</div>
							...
							<div class="panel-body">
								...
								<div class="tab-content">									
									...
									<div class="tab-pane active" id="work">
										...
										<?php include("work_travel_data.php"); ?>

									</div>

									<div class="tab-pane" id="payment">

										<?php include("work_travel_payment.php"); ?>

									</div>

									<div class="tab-pane" id="address">

										<?php include("work_travel_address.php"); ?>
													...
													<div class="card-body " id="bar-parent1">
														<form class="form-horizontal">
															<div class="form-group row" style="padding-top: 50px">
																...
																<div class="col-sm-4">
																	<a href="<?php echo base_url('Insurance_travel/work_travel_summary_print'); ?>" target="_blank">
																		<button type="button" class="btn btn-round btn-warning btn-sm m-b-10">
																			<i class="fa fa-print"></i> พิมพ์กรมธรรม์ประกันท่องเที่ยว
																		</button>
																	</a>
																</div>
															</div>
									...
									<div class="tab-pane" id="invoice">
										...
										<?php include("work_travel_invoice.php"); ?>

									</div>

									<div class="tab-pane" id="receipt">

										<?php include("work_travel_receipt.php"); ?>
