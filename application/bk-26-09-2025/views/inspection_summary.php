			...
			<div class="page-content-wrapper">
				...
				<div class="page-bar">
					<div class="page-title-breadcrumb">
						<div class=" pull-left">
							<div class="page-title">ใบส่งเงิน ตรอ</div>
						</div>
                        ...
                        <div class="col-md-12">
                            <div class="card card-topline-red">
                                <div class="card-head">
									...
									<div class="pull-right"><button type="button" class="btn btn-sm btn-danger" onClick="printData2('printME')">พิมพ์ใบส่งเงิน</button></div>
                                </div>
                                <div class="card-body ">
										...
										<form class="form-horizontal">
											<div class="form-group row">
												...
												<div class="col-sm-2">
												  ...
												  <div class="col-sm-1">
														<button type="button" class="btn btn-info btn-sm" onClick="loadSummary()">ตกลง</button>
												  </div>
