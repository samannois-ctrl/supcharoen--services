			...
			<div class="page-content-wrapper">
				...
				<div class="page-bar">
					<div class="page-title-breadcrumb">
						<div class=" pull-left">
							<div class="page-title">ประกันภัยท่องเที่ยว ประจำเดือน xxxxxxx 2565</div>
						</div>
					...
					<div class="row">
                        <div class="col-md-12">
                            <div class="card card-topline-red">
                                <div class="card-head">
                                    <header>รายการประกันภัยท่องเที่ยว</header>                                    
                                </div>
                                <div class="card-body ">
                                    <div class="row p-b-20">
                                        <div class="col-md-3 col-sm-2 col-3">
                                            <div class="btn-group">
												<a href="<?php echo base_url('Insurance_travel/work_travel_all');?>" class="nav-link">
