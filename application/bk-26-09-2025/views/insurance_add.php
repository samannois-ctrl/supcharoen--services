			...
			<div class="page-content">
				<div class="page-bar">
					<div class="page-title-breadcrumb">
						<div class="pull-left">
							<div class="page-title">ข้อมูลประกันภัย&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-sm btn-info" onClick="printInsurancePayment('cover')">พิมพ์ใบปะหน้า</button></div>
						</div>
						...
						<ol class="breadcrumb page-breadcrumb pull-right">
							...
							<li><?php //echo $dateWork?><input type="text" class="form-control datepicker" id="ins_date_work" placeholder="" name="ins_date_work" value="<?php echo $dateWork?>"></li>
							...
							<div class="card-body ">
									<div class="mdl-tabs mdl-js-tabs">
										...
										<div class="mdl-tabs__panel is-active p-t-20" id="tab4-panel">
											...
											<?php include("insurance_customer_insurance.php");
												  include("work_car_voluntary.php");
											...
											<div class="form-group row" style="padding-top: 3px; padding-left: 20px;">
											   <label class="col-sm-2 control-label text-danger">ใบเตือน</label><div class="col-sm-4">
												<input type="checkbox" id="recieve_warning" name="recieve_warning" value='1' <?php echo $check_recieve_warning?> onclick="uncheckRecieve('not_recieve_warning','recieve_warning',this)" > รับแล้ว <?php //echo $check_recieve_warning?>&nbsp;&nbsp;&nbsp;
												<input type="checkbox" id="not_recieve_warning" name="not_recieve_warning"  value='1' <?php echo $check_not_recieve_warning ?> onclick="uncheckRecieve('recieve_warning','not_recieve_warning',this)"  > ยังไม่รับ <?php //echo $check_not_recieve_warning ?>&nbsp;&nbsp;&nbsp;
												<input type="checkbox"  id="recieve_warning_yes" name="recieve_warning_yes"  value='1' <?php echo $recieve_warning_yes ?>> กรมธรรม์มาแล้ว
										
												</div>	
											</div>
											<div class="form-group row" style="padding-top: 3px; padding-left: 20px;">
												<div class="col-sm-2 text-primary">ยกเลิกกรมธรรม์</div>
												<div class="col-sm-4">
															<input type="checkbox" id="useInsurance" name="data_status[]" value="1" <?php if($data_status=='1'){ echo "checked";}?>> ใช้งาน &nbsp;&nbsp;	
															<input type="checkbox"  id="useInsurance" name="data_status[]" value="2" <?php if($data_status=='2'){ echo "checked";}?>> <span class="text-danger">ยกเลิก</span> 
												</div>
										...
										<div class="mdl-tabs__panel p-t-20" id="tab7-panel">
											<form id="insuranceImagesForm" name="insuranceImagesForm" method="post" enctype="multipart/form-data">
