...
<div class="card-head" style="text-align: center;">
							...
							<p style="font-weight: 400; line-height: 24px;">
								...
								<strong>โทรศัพท์</strong> <?php echo $tel1?>  <br>
								<strong>วันคุ้มครอง</strong> <?php echo $insurance_start?><br>
								<strong>
			 ...
			 $returnValue['bank_number']=$data->bank_number;*/
							  ...
							  <p align="center" style="padding-top: 30px; font-weight: bold; color:#AB0002; font-size: 18px;">** งวดถัดไป ชำระทุกวันที่ 
								  <?php  $vals = explode("-",$txtDuedate); 
										if(isset($vals[2])){
											echo (int)$vals[2];
										}else{ echo "10"; }
								  ?> **</p>
