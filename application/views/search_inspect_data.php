...
<?php $n=1; foreach($resultSearch['resultData'] AS $key){  
    ...
    <tr class="odd gradeX">
	  ...
	  <?php echo $this->insurance_model->translateDateToThai($key->workDate)?></td>
      ...
      <td align="center" title="ตรวจสภาพรถ" >
		  <?php if(($key->car_check_price!='0.00')&&($key->car_check_price!='')){ ?><i class="fa  fa-check-square-o 2x"></i>
		     <small><?php //echo $txtCheckPaid; } */?><?php }?>
		</td>
      <td align="center" title="พ.ร.บ.">
		  <?php if(($key->act_price_total!='0.00')&&($key->act_price_total!='')){ ?><i class="fa  fa-check-square-o 2x"></i><?php }?>
		</td>
      <td align="center" title="ภาษี">
		  <?php //echo "tax_price>".$key->tax_price;
	         if(($key->tax_price!='0.00')&&($key->tax_price!='')){ ?><i class="fa  fa-check-square-o 2x"></i><?php }?>
		</td>
      <td style="text-align: center"><a href="<?php echo base_url('Insurance_car/work_car_all/'.$CustID."/".$CarID."/".$workID)?>" target="_blank">
