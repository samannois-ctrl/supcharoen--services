			...
			<div class="page-content-wrapper">
				...
				<div class="page-bar">
					<div class="page-title-breadcrumb">
						<div class=" pull-left">
							<div class="page-title">วัน เดือน ปี จดทะเบียน</div>
						</div>
					...
					<div class="row">
                        <div class="col-md-12">
                            <div class="card card-topline-red">
                                <div class="card-head">
                                    <header>วัน เดือน ปี จดทะเบียน</header>   
									...
									<div class="col-md-12 col-sm-12 col-12">                                           
										...
										<form class="form-horizontal">
											<div class="form-group row">
												 <label class="col-sm-1 control-label">วันที่บันทึก</label>
												<div class="col-sm-1">
												...
												<div class="col-sm-1">
												  ...
												  <div class="col-sm-1">
														<button type="button" class="btn btn-info btn-sm" onClick="loadcareRegister()">ตกลง</button>
												  </div>
