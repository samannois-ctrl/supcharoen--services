											<div class="row">
												<div class="col-md-12 col-sm-12">
														...
														<div class="card-head">
															<header>ข้อมูลการชำระเงิน / ผ่อนประกันรถ</header>
															<ol class="breadcrumb page-breadcrumb pull-right">
																<li><a href="<?php echo base_url('Insurance_car/work_car_payment_print');?>" target="_blank"><button type="button" class="btn btn-warning btn-sm"><i class="fa fa-print"></i> พิมพ์สำหรับลูกค้า</button></a></li>
															</ol>
														</div>
																	...
																	<div class="col-sm-12">
																		<div class="card card-topline-aqua">
																			<div class="card-head" style="text-align: center;">
																				<header>ข้อมูลการชำระเงิน / ผ่อนประกันรถ ทะเบียน 82-6053สข</header>	
																			</div>
																			<div class="card-body ">
